...
/******/ 	var hotCurrentHash = "9e3305473b1ca2ce4ecb"; // eslint-disable-line no-unused-vars
...
/***/ function(module, exports, __webpack_require__) {
	...
	var service = new service_1.SocketService({
	    IsLogging: true,
	    HostUrl: 'https://developmentsockets.kreloses-local.com/signalr'
	});
	service.Connect(function (connected) {
	    console.log(connected);
	});
	service.Subscribe('SomeEvent', function (response) {
	    console.log(response);
	});
	service.Subscribe('EventNotExists', function (response) {
	    console.log(response);
	});
	service.Disconnect();
...
/***/ function(module, exports, __webpack_require__) {
	...
	var SocketService = (function () {
	    ...
	    SocketService.prototype.Subscribe = function (eventType, callback) {
	        this.subscriptions[eventType] = callback;
	        this.OnConnected();
	    };
	    SocketService.prototype.OnConnected = function () {
	        var _this = this;
	        var notification = $.connection.notificationHub;
	        notification.client.newNotification = function (eventType, jsonPayload) {
	            var handler = _this.subscriptions[eventType];
	            if (handler) {
